...
#ifndef YY_YY_PARSERBASE_HH_INCLUDED
# define YY_YY_PARSERBASE_HH_INCLUDED
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, Direction&& v)
        : Base (t)
        , value (std::move (v))
      {}
#else
      basic_symbol (typename Base::kind_type t, const Direction& v)
        : Base (t)
        , value (v)
      {}
#endif
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, std::unique_ptr<Action>&& v)
        : Base (t)
        , value (std::move (v))
      {}
#else
      basic_symbol (typename Base::kind_type t, const std::unique_ptr<Action>& v)
        : Base (t)
        , value (v)
      {}
#endif
...
switch (yykind)
    {
      ...
      {
        return ParserBase::symbol_name (this->kind ());
      }
#endif // #if YYDEBUG || 0
    ...
    // Implementation of make_symbol for each token kind.
      ...
      static
      symbol_type
      make_DIRECTION (std::string v)
      {
        return symbol_type (token::DIRECTION, std::move (v));
      }
#else
      static
      symbol_type
      ...
      static
      symbol_type
      make_VERB (std::string v)
      {
        return symbol_type (token::VERB, std::move (v));
      }
#else
      static
      symbol_type
      make_VERB (const std::string& v)
      {
        return symbol_type (token::VERB, v);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_NOUN (std::string v)
      {
        return symbol_type (token::NOUN, std::move (v));
      }
#else
      static
      symbol_type
      make_NOUN (const std::string& v)
      {
        return symbol_type (token::NOUN, v);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_ADJECTIVE (std::string v)
      {
        return symbol_type (token::ADJECTIVE, std::move (v));
      }
#else
      static
      symbol_type
      make_ADJECTIVE (const std::string& v)
      {
        return symbol_type (token::ADJECTIVE, v);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_UNKNOWN (std::string v)
      {
        return symbol_type (token::UNKNOWN, std::move (v));
      }
#else
      static
      symbol_type
  ...
  ParserBase::yytranslate_ (int t) YY_NOEXCEPT
  {
  ...
  // basic_symbol.
  template <typename Base>
  ParserBase::basic_symbol<Base>::basic_symbol (const basic_symbol& that)
    : Base (that)
    , value ()
  {
    switch (this->kind ())
  ...
  template <typename Base>
  ParserBase::symbol_kind_type
  ParserBase::basic_symbol<Base>::type_get () const YY_NOEXCEPT
  {
    return this->kind ();
  }
  ...
  template <typename Base>
  bool
  ParserBase::basic_symbol<Base>::empty () const YY_NOEXCEPT
  {
  ...
  template <typename Base>
  void
  ParserBase::basic_symbol<Base>::move (basic_symbol& s)
  {
    super_type::move (s);
    switch (this->kind ())
    {
  ...
  // by_kind.
  inline
  ParserBase::by_kind::by_kind () YY_NOEXCEPT
    : kind_ (symbol_kind::S_YYEMPTY)
  {}

#if 201103L <= YY_CPLUSPLUS
  inline
  ParserBase::by_kind::by_kind (by_kind&& that) YY_NOEXCEPT
    : kind_ (that.kind_)
  {
    that.clear ();
  }
  ...
  inline
  ParserBase::by_kind::by_kind (const by_kind& that) YY_NOEXCEPT
    : kind_ (that.kind_)
  {}

  inline
  ParserBase::by_kind::by_kind (token_kind_type t) YY_NOEXCEPT
  ...
  inline
  void
  ParserBase::by_kind::clear () YY_NOEXCEPT
  {
    kind_ = symbol_kind::S_YYEMPTY;
  }
  ...
  inline
  void
  ParserBase::by_kind::move (by_kind& that)
  {
    kind_ = that.kind_;
    that.clear ();
  }
  ...
  inline
  ParserBase::symbol_kind_type
  ParserBase::by_kind::kind () const YY_NOEXCEPT
  {
    return kind_;
  }
  ...
  inline
  ParserBase::symbol_kind_type
  ParserBase::by_kind::type_get () const YY_NOEXCEPT
  {
    return this->kind ();
  }
...
#line 1530 "parserbase.hh"




#endif // !YY_YY_PARSERBASE_HH_INCLUDED
